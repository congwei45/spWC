...
def get_argparser():
    ...
    parser.add_argument("--max_portion", type=float, default=0.5)
    parser.add_argument("--portion_step", type=float, default=0.02)
    parser.add_argument(
        "--out_dis", default=False, action="store_true", help="apply output distillation."
    )
    # Datset Options
